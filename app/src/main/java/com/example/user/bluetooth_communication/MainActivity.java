...
public class MainActivity<mRunnable> extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensor_temp = sensorManager.getSensorList(Sensor.TYPE_LIGHT).get(0);
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    public void doFirstWork()
      {
                if (mBluetoothConnection.incomingMessage != null) {
                    message = mBluetoothConnection.incomingMessage;
                }
    ...
    public void doSecondWork(){
        String sensorValues="nu e";


        sensorValues =Float.toString(temperature);

        byte[] bytes = sensorValues.getBytes(Charset.defaultCharset());
